...
import net.reichholf.nfrdroid.helpers.enigma2.requesthandler.RemoteCommandRequestHandler;
...
public class WidgetService extends HttpIntentService {
	...
	public static final String ACTION_ZAP = "net.reichholf.nfrdroid.appwidget.WidgetService.ACTION_ZAP";
	public static final String ACTION_RCU = "net.reichholf.nfrdroid.appwidget.WidgetService.ACTION_RCU";
