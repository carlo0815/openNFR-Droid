...
import net.reichholf.nfrdroid.helpers.enigma2.requestinterfaces.SimpleRequestInterface;
import net.reichholf.nfrdroid.parsers.enigma2.saxhandler.E2SimpleHandler;
...
public abstract class AbstractSimpleRequestHandler implements SimpleRequestInterface {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.reichholf.nfrdroid.helpers.enigma2.requesthandler.
	 * SimpleRequestParamInterface
	 * #get(net.reichholf.nfrdroid.helpers.SimpleHttpClient,
	 * java.util.ArrayList)
	 */
