...
import net.reichholf.nfrdroid.util.Base64;
...
public class SimpleHttpClient {
	...
	public static String BIG_BUCK_BUNNY_URL = "https://nfrdroid.org/bunny/big_buck_bunny_720p_h264.mov";
	...
	public String buildEncoderStreamUrl(String ref) {
		if (mProfile.getHost().equals("nfrdroid.org"))
	...
	private void dumpToFile(URL url) {
		...
		String base = String.format("%s/nfrdroid/xml", externalStorage);
