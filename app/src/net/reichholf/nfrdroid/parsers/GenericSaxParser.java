...
package net.reichholf.nfrdroid.parsers;

import android.util.Log;

import net.reichholf.nfrdroid.dataProviders.interfaces.DataParser;
...
public class GenericSaxParser implements DataParser {
	 ...
	 * 
	 * @see
	 * net.reichholf.nfrdroid.dataProviders.interfaces.DataParser#parse(java
	 * .lang.String)
	 */
