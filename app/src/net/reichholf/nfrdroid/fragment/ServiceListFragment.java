...
import net.reichholf.nfrdroid.fragment.helper.HttpFragmentHelper;
import net.reichholf.nfrdroid.helpers.ExtendedHashMap;
import net.reichholf.nfrdroid.helpers.NameValuePair;
import net.reichholf.nfrdroid.helpers.RecyclerViewPauseOnScrollListener;
import net.reichholf.nfrdroid.helpers.Statics;
import net.reichholf.nfrdroid.helpers.SyncService;
...
import net.reichholf.nfrdroid.helpers.enigma2.requesthandler.ServiceListRequestHandler;
...
import net.reichholf.nfrdroid.widget.AutofitRecyclerView;
