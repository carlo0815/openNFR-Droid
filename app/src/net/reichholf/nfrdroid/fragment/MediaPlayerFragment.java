...
import net.reichholf.nfrdroid.adapter.MediaListAdapter;
import net.reichholf.nfrdroid.fragment.abs.AbstractHttpListFragment;
...
import net.reichholf.nfrdroid.helpers.enigma2.Mediaplayer;
import net.reichholf.nfrdroid.helpers.enigma2.SimpleResult;
import net.reichholf.nfrdroid.helpers.enigma2.URIStore;
import net.reichholf.nfrdroid.helpers.enigma2.requesthandler.AbstractSimpleRequestHandler;
import net.reichholf.nfrdroid.helpers.enigma2.requesthandler.MediaplayerCommandRequestHandler;
import net.reichholf.nfrdroid.helpers.enigma2.requesthandler.MediaplayerCurrentRequestHandler;
import net.reichholf.nfrdroid.helpers.enigma2.requesthandler.MediaplayerListRequestHandler;
