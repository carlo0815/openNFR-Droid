...
import net.reichholf.nfrdroid.helpers.enigma2.CurrentService;
...
import net.reichholf.nfrdroid.helpers.enigma2.Timer;
import net.reichholf.nfrdroid.helpers.enigma2.requesthandler.CurrentServiceRequestHandler;
import net.reichholf.nfrdroid.helpers.enigma2.requesthandler.TimerAddByEventIdRequestHandler;
import net.reichholf.nfrdroid.intents.IntentFactory;
import net.reichholf.nfrdroid.loader.AsyncSimpleLoader;
...
public class CurrentServiceFragment extends BaseHttpFragment {
	 ...
	 * 
	 * @see
	 * net.reichholf.nfrdroid.abstivities.AbstractHttpListActivity#onSimpleResult
	 * (boolean, net.reichholf.nfrdroid.helpers.ExtendedHashMap)
	 */
