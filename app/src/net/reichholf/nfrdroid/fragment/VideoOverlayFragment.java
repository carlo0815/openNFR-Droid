...
import net.reichholf.nfrdroid.activities.VideoActivity;
import net.reichholf.nfrdroid.adapter.recyclerview.ServiceAdapter;
import net.reichholf.nfrdroid.fragment.dialogs.ActionDialog;
import net.reichholf.nfrdroid.fragment.dialogs.EpgDetailBottomSheet;
...
import net.reichholf.nfrdroid.helpers.DateTime;
...
import net.reichholf.nfrdroid.helpers.enigma2.Service;
import net.reichholf.nfrdroid.helpers.enigma2.URIStore;
import net.reichholf.nfrdroid.helpers.enigma2.requesthandler.AbstractListRequestHandler;
import net.reichholf.nfrdroid.helpers.enigma2.requesthandler.EpgNowNextListRequestHandler;
...
import net.reichholf.nfrdroid.tv.fragment.EpgDetailDialog;
import net.reichholf.nfrdroid.tv.fragment.MovieDetailDialog;
import net.reichholf.nfrdroid.video.VLCPlayer;
import net.reichholf.nfrdroid.view.OnRepeatListener;
import net.reichholf.nfrdroid.widget.helper.ItemClickSupport;
import net.reichholf.nfrdroid.widget.helper.SpacesItemDecoration;
