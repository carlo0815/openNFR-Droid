...
import net.reichholf.nfrdroid.ProfileChangedListener;
...
import net.reichholf.nfrdroid.asynctask.CheckProfileTask;
import net.reichholf.nfrdroid.fragment.ActivityCallbackHandler;
import net.reichholf.nfrdroid.fragment.EpgSearchFragment;
import net.reichholf.nfrdroid.fragment.ProfileEditFragment;
import net.reichholf.nfrdroid.fragment.ProfileListFragment;
import net.reichholf.nfrdroid.fragment.dialogs.ActionDialog;
import net.reichholf.nfrdroid.fragment.dialogs.ChangelogDialog;
import net.reichholf.nfrdroid.fragment.dialogs.ConnectionErrorDialog;
...
import net.reichholf.nfrdroid.fragment.helper.NavigationHelper;
import net.reichholf.nfrdroid.fragment.interfaces.IHttpBase;
...
public class MainActivity extends BaseActivity implements MultiPaneHandler, ProfileChangedListener,
	 ...
	 * (non-Javadoc)
	 *
	 * @see net.reichholf.nfrdroid.OnActiveProfileChangedListener#
	 * onActiveProfileChanged(net.reichholf.nfrdroid.Profile)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see net.reichholf.nfrdroid.fragment.dialogs.EpgDetailBottomSheet.
